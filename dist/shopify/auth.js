...
export class ShopifyAuthService {
    ...
    async completeCallback(query, correlationId) {
        ...
        let carrierServiceId = undefined;
        try {
            carrierServiceId = await this.deps.carrierServiceManager.ensureCarrierService(shop, token.access_token, `${this.deps.appUrl}/shopify/carrier-service/rates`);
        }
        catch (err) {
